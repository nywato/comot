var Comot = {
    ...
    run: function(n) {
        for (var e = n.click, t = n.interval, o = document.getElementsByClassName("comot"), c = 0, r = o.length; c < r; c++) o[c].addEventListener("click", function() {
            tn = Comot.readData("nct"), po = tn - 1 + 2, Comot.changer(e, t) ? document.cookie = "nct=" + po + ";" : Comot.n("pointer-events:none;")
        })
    },
    changer: function(n, e) {
        return tc = this.readData("nct") - 1 + 2, tc != n || (setTimeout(function() {
            document.cookie = "nct=0;", Comot.n("pointer-events:cursor;")
        }, e), !1)
    },
    n: function(n) {
